...
func (a *CPUApp) healthCheck(w http.ResponseWriter, r *http.Request) {
	resp := &Response{"", ""}
	respondWithJSON(w, 200, resp)
}

// Run function is the entry point
func (a *CPUApp) Run(addr string) error {
